...
extensions = ["sphinx_togglebutton", "sphinx_copybutton", "myst_nb", "jupyter_book", "sphinx_thebe", "sphinx_comments", "sphinx_external_toc", "sphinx.ext.intersphinx", "sphinx_design", "sphinx_book_theme", "numpydoc", "sphinx.ext.autodoc", "sphinx.ext.autosummary", "sphinxcontrib.bibtex", "sphinx_jupyterbook_latex"]
...
intersphinx_mapping = {"python": ["https://docs.python.org/3/", None], "matplotlib": ["https://matplotlib.org/stable", None], "numpy": ["https://numpy.org/doc/stable/", None], "pandas": ["https://pandas.pydata.org/pandas-docs/stable", None]}
