...
phantom1T5 = Phantom.from_brainweb(sub_id=4, sim_conf=sim_conf, tissue_file="tissue_1T5")
...
interact(live_contrast, TE = (0, 100, 1), TR=(0,1000,1), FA=(0,90,1), tissue_field=["1T5", "7T"])
# -
